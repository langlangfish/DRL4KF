...
# Desc:         Code to process Rinex v2 files
########################################################################
  ...
  with open(input_path, 'r') as f:
    ...
    if line[20] == 'N':
      ...
      fields = ['SVclockBias', 'SVclockDrift', 'SVclockDriftRate',
                ...
                'TransTime', 'FitIntvl']# and two spare same with RINEX3.04 GPS description
    elif line[20] == 'G':
      svtype = 'R'  # GLONASS
      ...
      svtype = 'C' # Compass BDS
      fields = ['SVclockBias', 'SVclockDrift', 'SVclockDriftRate',
                'AODE', 'Crs', 'DeltaN', 'M0',
                'Cuc', 'Eccentricity', 'Cus', 'sqrtA',
                'Toe', 'Cic', 'Omega0', 'Cis',
                'Io', 'Crc', 'omega', 'OmegaDot',
                'IDOT', 'spare', 'BDTWeek', 'spare',
                'SVacc', 'health', 'TGD1', 'TGD2',
                'TransTime', 'AODC']# and 2 spare
    elif line[20] == 'E':
      svtype = 'E' # GALILEO
      fields = ['SVclockBias', 'SVclockDrift', 'SVclockDriftRate',
                ...
                'Toe', 'Cic', 'Omega0', 'Cis',
                'Io', 'Crc', 'omega', 'OmegaDot',
                'IDOT', 'Data sources', 'GalWeek', 'spare',
                'SVacc', 'health', 'BGD E5a/E1', 'BGD E5b/E1',
                'TransTime']#and 3 spare
    else:
